      ...
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-12">
        <section className="flex flex-col gap-5">
          ...
          <h1 className="text-display max-w-3xl text-4xl font-semibold text-dsa-text-strong md:text-5xl">
            Step-through visualizer for data structures and algorithms.
          </h1>
          <p className="max-w-[60ch] text-[15px] leading-7 text-dsa-muted">
            Pick a topic, run an operation, scrub the trace. Each step highlights the active indices,
            updates the pseudocode pointer, and logs what changed.
          </p>
